...
import type { NewAccountBody } from "@syncellus/types/index.d.ts";
...
export class AccountsController {
  ...
  public createAccount = async (
    req: TypedRequest<NewAccountBody>,
    res: Response,
  ) => {
  ...
  public updateAccount = async (
    req: TypedRequest<Updateable<AccountsProfiles>>,
    res: Response,
  ) => {
    const { id } = req.params;
    const data = req.body;
