...
export interface ITasksRepository {
    ...
    insertTasksToDB(tasks: Insertable<WorkspacesTasks>[]): Promise<Selectable<WorkspacesTasks>[]>;
    updateTaskByIDInDB(id: string, task: Updateable<WorkspacesTasks>): Promise<Selectable<WorkspacesTasks>>;
    deleteTaskByIDinDB(id: string): Promise<DeleteResult>;
}

export interface ITasksService {
    insertNewTasks(tasks: Insertable<WorkspacesTasks>[]): Promise<Selectable<WorkspacesTasks>[]>;
    selectAllTasks(): Promise<Selectable<WorkspacesTasks>[]>;
    selectTaskByID(id: string): Promise<Selectable<WorkspacesTasks>>;
    updateTaskByID(id: string, task: Updateable<WorkspacesTasks>): Promise<Selectable<WorkspacesTasks>>;
