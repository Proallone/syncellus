...
import { TimesheetsPostSchema, TimesheetsUpdateSchema } from "@syncellus/modules/workspaces/timesheets/schema.ts";
...
router.post("/", validate(TimesheetsPostSchema), hw(controller.createTimesheets));
router.patch("/:id", validate(TimesheetsUpdateSchema), hw(controller.patchTimesheet));
