...
import healthRouter from "@syncellus/modules/health/routes.ts";
import authRouter from "@syncellus/modules/auth/routes.ts";
import accountsRouter from "@syncellus/modules/accounts/routes.ts";
import workspacesRouter from "@syncellus/modules/workspaces/routes.ts";
