import type { IMailProvider, IMailService } from "@syncellus/modules/mail/types.d.ts";
import { compileTemplate } from "@syncellus/modules/mail/utils/compileTemplate.ts";
