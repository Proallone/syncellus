import type { AccountsProfiles, DB } from "@syncellus/hono/types/database.d.ts";
import type { Insertable, Kysely } from "kysely";
import { schema } from "@syncellus/hono/database/migrations/1756406769551_accounts.ts";
